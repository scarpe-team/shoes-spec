#!/usr/bin/env ruby
# Run batch 24 tests - Standalone version
...
BATCH_FILE = File.join(SHOES_SPEC_DIR, "batches/batch_24.txt")
...
def run_test(sspec_path)
  ...
  begin
    ...
    sspec_file = File.join(SHOES_SPEC_DIR, "implementations/niente/sspec_batch24.json")
    ...
    env = {
      ...
      "SHOES_MINITEST_CLASS_NAME" => "Batch24",
...
# Write JSON results
results_json = File.join(SHOES_SPEC_DIR, "results/batch_24_results.json")
