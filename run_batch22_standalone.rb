#!/usr/bin/env ruby
# Run batch 22 tests - Standalone version
...
BATCH_FILE = File.join(SHOES_SPEC_DIR, "batches/batch_22.txt")
...
def run_test(sspec_path)
  ...
  begin
    ...
    sspec_file = File.join(SHOES_SPEC_DIR, "implementations/niente/sspec_batch22.json")
    ...
    env = {
      ...
      "SHOES_MINITEST_CLASS_NAME" => "Batch22",
...
# Write JSON results
results_json = File.join(SHOES_SPEC_DIR, "implementations/niente/batch_22_results.json")
