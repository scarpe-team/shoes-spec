#!/usr/bin/env ruby
# Run batch 23 tests - Standalone version
...
BATCH_FILE = File.join(SHOES_SPEC_DIR, "batches/batch_23.txt")
...
def run_test(sspec_path)
  ...
  begin
    ...
    sspec_file = File.join(SHOES_SPEC_DIR, "implementations/niente/sspec_batch23.json")
    ...
    env = {
      ...
      "SHOES_MINITEST_CLASS_NAME" => "Batch23",
...
# Write JSON results
results_json = File.join(SHOES_SPEC_DIR, "results/batch_23_results.json")
