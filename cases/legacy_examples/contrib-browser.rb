# NOTE from Scarpe: this wants to find an example in known subdirectory names in contrib.
# But our repository isn't laid out that way. How do we want to do this?
