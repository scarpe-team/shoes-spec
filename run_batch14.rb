...
BATCH_FILE = File.join(__dir__, "batches/batch_14.txt")
...
def run_test(sspec_path)
  ...
  with_tempfiles([
    ...
    sspec_file = File.join(__dir__, "implementations/niente/sspec_batch14.json")
    
    ENV["SHOES_SPEC_TEST"] = test_file
    ENV["SCARPE_DISPLAY_SERVICE"] = "niente"
    ENV["SHOES_MINITEST_EXPORT_FILE"] = sspec_file
    ENV["SHOES_MINITEST_CLASS_NAME"] = "Batch14"
