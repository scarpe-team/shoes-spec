#!/usr/bin/env ruby
# Run batch 21 tests - Standalone version
...
BATCH_FILE = File.join(SHOES_SPEC_DIR, "batches/batch_21.txt")
...
def run_test(sspec_path)
  ...
  begin
    ...
    sspec_file = File.join(SHOES_SPEC_DIR, "implementations/niente/sspec_batch21.json")
    ...
    env = {
      ...
      "SHOES_MINITEST_CLASS_NAME" => "Batch21",
...
# Write JSON results
results_json = File.join(SHOES_SPEC_DIR, "implementations/niente/batch_21_results.json")
